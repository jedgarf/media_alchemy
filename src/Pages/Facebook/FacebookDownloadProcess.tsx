            ...
            <Container fluid="lg">
                <Row>
                    ...
                    <Col sm={12} md={12}>
                        ...
                        <h5>3. Open <b>{title}</b> and paste the video URL in our converter and click blue arrow-left button. After that you will be able to choose the download format. You can choose between SD or HD.</h5>
